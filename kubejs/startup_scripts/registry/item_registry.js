...
StartupEvents.registry("item", event => {
    ...
    event.create('thermal:upgrade_augment_5');
    event.create('thermal:upgrade_augment_6');
    event.create('thermal:upgrade_augment_7');
    ...
    // Aluminium chloride 
    event.create('aluminium_chloride').displayName('Aluminium Chloride')
    event.create('crystal_meth').displayName('Crystalized Methamphetamine').texture('kubejs:item/creth_dust')

    // Joke items
    event.create('fireball_milk').food(food => {food.effect('minecraft:speed', 1200, 3, 1).effect('minecraft:nausea', 600, 2, 1)})
      .displayName('Fireball Milk')
      .tooltip("Hell part 1")
      .useAnimation('drink')
      .maxStackSize(16);
    event.create('lemon_milk').food(food => {food.effect('minecraft:resistance', 1200, 4, 1).effect('minecraft:nausea', 900, 4, 1)})
      .displayName('Lemon Milk')
      .tooltip("Hell part 2")
      .useAnimation('drink')
      .maxStackSize(16);
    event.create('dodo_pizza').food(food => {food.hunger(14).saturation(1)}).displayName("Mario's Cockless Pizza With Extra Balls").maxStackSize(4);
    event.create('cock_balls').displayName("Cock and also Balls");
})
