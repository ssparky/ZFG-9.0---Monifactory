...
GTCEuStartupEvents.registry('gtceu:recipe_type', event => {
    ...
    // Naquadah Fuel Refinery (hardmode)
    ...
    // NEW CHANGES
    // Fermentation Barrel
    event.create('fermentation_barrel')
        .category('multiblock')
        .setEUIO('in')
    ...
    // Artificial Dragon Forge
    event.create('artificial_dragon_forge')
        .category('multiblock')
        .setEUIO('in')
    ...
    // Solar grain drier
    event.create('solar_grain_drier')
        .category('multiblock')
        .setEUIO('in')
        .setMaxIOSize(1,1,0,0)
        .setSlotOverlay(false,false, GuiTextures.SOLIDIFIER_OVERLAY)
    ...
    // Advanced culinary array
    event.create('advanced_culinary_array')
        .category('multiblock')
        .setEUIO('in')
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    // Lattice Cutter
    event.create('lattice_cutter', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes('lattice_cutter')
        .appearanceBlock(() => Block.getBlock('kubejs:lattice_cutter_casing'))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("CCC", "CCC", "GGG", "GGG")
            .aisle("CCC", "CCC", "GGG", "GGG")
            .aisle("C@C", "CCC", "GGG", "GGG")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where('C', Predicates.blocks("kubejs:lattice_cutter_casing").setMinGlobalLimited(10)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
            .where('G', Predicates.blocks("kubejs:lattice_cutter_glass"))
            .build())
        .workableCasingRenderer("kubejs:block/lattice_cutter/lattice_cutter_casing",
            "gtceu:block/multiblock/fusion_reactor", false)

    // NEW CHANGES
    // Fermentation Barrel
    event.create('fermentation_barrel', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes('fermentation_barrel')
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT])
        .appearanceBlock(() => Block.getBlock('gtceu:clean_machine_casing'))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("F#F", "CCC", "CCC", "CCC")
            .aisle("N#N", "CCC", "C C", "CCC")
            ...
            .aisle("F#F", "CCC", "C@C", "CCC")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where('C', Predicates.blocks("gtceu:clean_machine_casing").setMinGlobalLimited(12)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
            .where(' ', Predicates.air())
            .where('#', Predicates.any())
            .where('N', Predicates.blocks("gtceu:treated_wood_frame"))
            .where('F', Predicates.blocks("gtceu:treated_wood_fence"))
            .build())
    ...
    // Artificial Dragon Forge
    event.create('artificial_dragon_forge', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes('artificial_dragon_forge')
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT])
        .appearanceBlock(() => Block.getBlock('kubejs:dark_soularium_casing'))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("#CCC#","CGGGC","CGMGC","CGGGC","CCCCC","#####")
            .aisle("CCCCC","G   G","G   G","G   G","C   C","CGGGC")
            .aisle("CCCCC","G S G","G S G","G S G","CCCCC","CCCCC")
            .aisle("CCCCC","G   G","G   G","G   G","C   C","CGGGC")
            .aisle("#CCC#","CC CC","C   C","CC CC","CCCCC","#####")
            .aisle("#BCB#","BD DB","G   G","BD DB","#BCB#","#####")
            .aisle("#BCB#","BD DB","G   G","BD DB","#BCB#","#####")
            .aisle("#BCB#","BD DB","G   G","BD DB","#BCB#","#####")
            .aisle("#CCC#","CLLLC","C F C","CLLLC","#CCC#","#####")
            .aisle("CCCCC","CLLLC","G F G","CLLLC","CCCCC","CBBBC")
            .aisle("#CCC#","CLLLC","C F C","CLLLC","#CCC#","#####")
            .aisle("#####","#CCC#","#C@C#","#CCC#","#####","#####")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where('C', Predicates.blocks("kubejs:dark_soularium_casing").setMinGlobalLimited(40)
                ...
                .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)))
            .where('G', Predicates.blocks("kubejs:lattice_cutter_glass"))
            .where('B', Predicates.blocks("iceandfire:dragon_bone_block"))
            .where('D', Predicates.blocks("iceandfire:dragonscale_red")
                .or(Predicates.blocks("iceandfire:dragonscale_green"))
                .or(Predicates.blocks("iceandfire:dragonscale_bronze"))
                .or(Predicates.blocks("iceandfire:dragonscale_gray"))
                .or(Predicates.blocks("iceandfire:dragonscale_blue"))
                .or(Predicates.blocks("iceandfire:dragonscale_white"))
                .or(Predicates.blocks("iceandfire:dragonscale_sapphire"))
                .or(Predicates.blocks("iceandfire:dragonscale_silver"))
                .or(Predicates.blocks("iceandfire:dragonscale_electric"))
                .or(Predicates.blocks("iceandfire:dragonscale_amythest"))
                .or(Predicates.blocks("iceandfire:dragonscale_copper"))
                .or(Predicates.blocks("iceandfire:dragonscale_black")))
            .where('S', Predicates.blocks("gtceu:damascus_steel_block"))
            .where('F', Predicates.blocks("gtceu:stellite_100_block"))
            .where('L', Predicates.blocks("minecraft:magma_block"))
            .where('M', Predicates.abilities(PartAbility.MUFFLER))
            .where('#', Predicates.any())
            .where(' ', Predicates.air())
            .build())
        .workableCasingRenderer("kubejs:block/soularium/casing",
            "gtceu:block/machines/alloy_smelter", false)

    // Solar Grain Drier
    event.create('solar_grain_drier', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes('solar_grain_drier')
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT])
        .appearanceBlock(() => Block.getBlock('gtceu:heatproof_machine_casing'))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("#CCCCC#","#CCCCC#","##FCF##")
            .aisle("#CPCPC#","#C P C#","##GCG##")
            .aisle("#CPCPC#","#C P C#","#FGCGF#")
            .aisle("FCPCPCF","FC P CF","FFGCGFF")
            .aisle("#CPCPC#","#C P C#","#FGCGF#")
            .aisle("#CPCPC#","#C P C#","##GCG##")
            .aisle("#CC@CC#","#CCCCC#","##FCF##")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where('C', Predicates.blocks("gtceu:heatproof_machine_casing").setMinGlobalLimited(12)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
            .where('P', Predicates.blocks("gtceu:treated_wood_planks"))
    ...
    // Advanced Culinary Array
    event.create('advanced_culinary_array', 'multiblock')
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes('advanced_culinary_array')
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT])
        .appearanceBlock(() => Block.getBlock('gtceu:clean_machine_casing'))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("########F###F#","########F###F#","########CGGGC#","########CGGGC#","########CGGGC#","#########CCC##","##########F###","##############")
            .aisle("FCCCF###FCCCF#","FCCCF###CGGGC#","FGGGF##C     C","FVVVF##C     C","F###F##C  B  C","########C   C#","#########CCC##","##########F###")
            .aisle("CKKKCFF#CCCCC#","C  HCIICCAAACC","G   G  C  B  G","CXXXC##G     G","#CCC###G  B  G","#######C     C","########CGGGC#","##########F###")
            .aisle("CKKKCCCCCCCCC#","C  PPPPPPAPACC","G   CIIC BPB G","C   C  G  P  G","#CCC###GBBPBBG","#######C  P  C","########CGCGC#","##########F###")
            .aisle("CKKKCFF#CCCCC#","C  HCIICCAAACC","G   G  C  B  G","CXXXC##G     G","#CCC###G  B  G","#######C     C","########CGGGC#","##########F###")
            .aisle("FCCCF###FCCCF#","FC@CF###CGGGC#","FGGGF##C     C","FVVVF##C     C","F###F##C  B  C","########C   C#","#########CCC##","##########F###")
            .aisle("########F###F#","########F###F#","########CGGGC#","########CGGGC#","########CGGGC#","#########CCC##","##########F###","##############")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where('C', Predicates.blocks("gtceu:clean_machine_casing").setMinGlobalLimited(12)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
            ...
            .where(' ', Predicates.air())
            .where('#', Predicates.any())
            .where('K', Predicates.blocks("cookingforblockheads:white_kitchen_floor"))
            ...
            .where('A', Predicates.blocks("gtceu:slicing_blades"))
            .where('X', Predicates.blocks("gtceu:tungstensteel_firebox_casing"))
            .where('V', Predicates.blocks("gtceu:computer_heat_vent"))
            .build())
        .workableCasingRenderer("gtceu:block/casings/solid/machine_casing_clean_stainless_steel",
            "gtceu:block/machines/canner", false)
