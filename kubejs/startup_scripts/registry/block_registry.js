...
StartupEvents.registry("block", event => {
    ...
    // Tesseract precursors
    event.create('tesseract_empty')
        .displayName('Empty Tesseract Frame')
        .soundType('metal')
        .hardness(20.0)
        .resistance(20.0)
        .requiresTool(true)
        ...
        .defaultCutout()
        .fullBlock(false);
    event.create('tesseract_filled')
        .displayName('Filled Tesseract Frame')
        .soundType('metal')
        .hardness(20.0)
        .resistance(20.0)
        .requiresTool(true)
    ...
    // Lattice cutter glass
    event.create('lattice_cutter_glass')
        .soundType('glass')
        .resistance(6).hardness(5)
        .tagBlock("mineable/pickaxe")
        .tagBlock("forge:mineable/wrench")
        ...
        .defaultCutout()
        .fullBlock(false)
        .textureAll("kubejs:block/lattice_cutter/lattice_cutter_glass");
});
