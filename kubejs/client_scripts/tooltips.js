...
ItemEvents.tooltip(tooltip => {
    ...
    tooltip.add(['thermal:upgrade_augment_1', 'thermal:upgrade_augment_2', 'thermal:upgrade_augment_4', 'thermal:upgrade_augment_3', 'thermal:dynamo_output_augment', 'thermalendergy:endergy_upgrade_1', 'thermalendergy:endergy_upgrade_2', 'thermalendergy:endergy_upgrade_3'], Text.translatable('thermal.emi.tooltip'))
    ...
    tooltip.add('gtceu:lattice_cutter', 'Uses precision laser arrays to cut and form inputs into lattices.')
    // NEW CHANGES
    tooltip.add('gtceu:fermentation_barrel', 'Specialized environment for brewing alcoholic beverages.')
    tooltip.add('gtceu:artificial_dragon_forge', 'Mimics dragon-forging through advanced alloys.')
    ...
    // Thermal Endergy
    // Prismalium
    const prismalium = ['thermalendergy:prismalium_ingot', 'thermalendergy:prismalium_nugget', 'thermalendergy:prismalium_block', 'thermalendergy:prismalium_dust', 'thermalendergy:prismalium_gear', 'thermalendergy:prismalium_plate', 'thermalendergy:prismalium_coin']
    prismalium.forEach(item => {
        tooltip.add(item, '§e(Al₂SiFH₂)₈(Pb₄Pt₂((CuAg₄)(BiZnCu₃)Fe₂(Ni(AuAgCu₃)Fe₃)₄)OsTa)₄Eu₂AuCa₃(PO₄)₂Pu₂Am(SiO₂)₄')
    })
    

    // Melodium
    const melodium = ['thermalendergy:melodium_ingot', 'thermalendergy:melodium_nugget', 'thermalendergy:melodium_block', 'thermalendergy:melodium_dust', 'thermalendergy:melodium_gear', 'thermalendergy:melodium_plate', 'thermalendergy:melodium_coin']
    melodium.forEach(item => {
        tooltip.add(item, '§e((SiO₂)(Si(FeS₂)₅(CrAl₂O₃)Hg₃)(SiO₂))₅(InGaP)₈Cm₆Nt₂Nth˟')
    })

    // Stellarium
    const stellarium = ['thermalendergy:stellarium_ingot', 'thermalendergy:stellarium_nugget', 'thermalendergy:stellarium_block', 'thermalendergy:stellarium_dust', 'thermalendergy:stellarium_gear', 'thermalendergy:stellarium_plate', 'thermalendergy:stellarium_coin']
    stellarium.forEach(item => {
        tooltip.add(item, '§eC˟₄∞₂Ho₅((SiO₂)(Si(FeS₂)₅(CrAl₂O₃)Hg₃)(SiO₂))₅(InGaP)₈Cm₆Nt₂Nth˟((Al₂SiFH₂)₈(Pb₄Pt₂((CuAg₄)(BiZnCu₃)Fe₂(Ni(AuAgCu₃)Fe₃)₄)OsTa)₄Eu₂AuCa₃(PO₄)₂Pu₂Am(SiO₂)₄)₂')
    })
})
