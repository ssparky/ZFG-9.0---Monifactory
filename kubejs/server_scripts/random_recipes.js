...
ServerEvents.recipes(event => {
    ...
    // Energy meter
    event.remove({id: 'energymeter:meter'})
    event.shaped('energymeter:meter', [
        ...
        C: 'gtceu:red_alloy_hex_wire',
        D: 'minecraft:observer',
        E: 'kubejs:resonating_crystal'
    }).id('kubejs:energymeter/meter')

    // Tesseract
    event.remove({id: 'tesseract:tesseract'})
    event.shaped('kubejs:tesseract_empty', [
        'BAB',
        'A A',
        'BAB'
    ], {
        A: '#forge:frames/tungsten_steel',
        B: '#forge:springs/platinum'
    }).id('kubejs:tesseract/tesseract_empty')
    event.recipes.gtceu.canner('kubejs:tesseract_filled')
        .itemInputs('kubejs:tesseract_empty')
        .inputFluids('thermal:ender 4000')
        .itemOutputs('kubejs:tesseract_filled')
        .duration(500)
        .EUt(5000)
    event.recipes.gtceu.assembler('kubejs:tesseract')
        .itemInputs('kubejs:tesseract_filled', '4x #forge:double_plates/black_bronze', '6x #forge:fine_wires/lumium', '4x #forge:rods/long/tungsten', '2x #gtceu:circuits/iv', '6x ae2:fluix_pearl')
    ...
    event.shaped('morphtool:tool', [
        ...
        D: '#forge:gems/ruby'
    }).id('kubejs:morphtool/morphtool')

    // Create deco
    event.recipes.gtceu.arc_furnace("industrial_iron")
        .itemInputs("gtceu:wrought_iron_ingot")
        .inputFluids("gtceu:oxygen 60")
    ...
    event.shaped('enchantinginfuser:advanced_enchanting_infuser', [
        ...
        A: '#forge:plates/ruridit',
        B: '#forge:exquisite_gems',
        C: 'minecraft:writable_book',
        D: 'enchantinginfuser:enchanting_infuser',
        E: 'create_enchantment_industry:hyper_experience_bottle'
    }).id('kubejs:enchantinginfuser/advanced_enchanting_infuser')

    // Netherite Horse Armor
    event.smithing('netherite_horse_armor:netherite_horse_armor', 'minecraft:netherite_upgrade_smithing_template', 'minecraft:diamond_horse_armor', 'minecraft:netherite_ingot')

    // Create enchantment industry
    event.recipes.gtceu.mixer('create_enchantment_industry:hyper_experience')
        .itemInputs('4x minecraft:glow_ink_sac', '4x #forge:plates/lapis')
        .inputFluids('enderio:xp_juice 8000')
        .outputFluids('create_enchantment_industry:hyper_experience 1500')
        .duration(400)
        .EUt(GTValues.VA[GTValues.EV])

    event.recipes.gtceu.extractor('create_enchantment_industry:ink')
        .itemInputs('minecraft:ink_sac')
        .outputFluids('create_enchantment_industry:ink 144')
        .duration(100)
        .EUt(GTValues.VA[GTValues.LV])

    // Way to get black dye from charcoal/carbon, because ink is not renewable
    event.shaped('4x minecraft:black_dye', [
        ' C ',
        'C C',
        ' C '
    ], 
    ...
    }).id('kubejs:black_dye_from_charcoal')

    // Aquaculture neptunium into nuclearcraft neptunium-237
    event.recipes.gtceu.thermal_centrifuge('kubejs:neptunium_237')
        .itemInputs('aquaculture:neptunium_ingot')
        .itemOutputs('nuclearcraft:neptunium_237')
        .duration(2000)
        .EUt(GTValues.VA[GTValues.EV])

    // NEW CHANGES
    // Other log types that can be centrifuged, outside of just gtceu rubber
    event.recipes.gtceu.centrifuge('kubejs:thermal_rubber_centrifuge')
        .itemInputs('thermal:rubberwood_log')
        ...
        .outputFluids('gtceu:methane 60')
        .duration(200)
        .EUt(GTValues.VA[GTValues.LV])
    event.recipes.gtceu.centrifuge('kubejs:ru_kapok_centrifuge')
        .itemInputs('regions_unexplored:kapok_log')
        .chancedOutput('gtceu:sticky_resin', 3300, 800)
        .chancedOutput('gtceu:plant_ball', 3750, 900)
        .chancedOutput('gtceu:carbon_dust', 3500, 850)
        .chancedOutput('gtceu:wood_dust', 3000, 750)
        .outputFluids('gtceu:methane 30')
        .duration(200)
        .EUt(GTValues.VA[GTValues.LV])

    // Artificial dragon forge recipes
    event.shaped('gtceu:artificial_dragon_forge', 
        [
            'CBC',
            'BAB',
            'CBC'
        ], {
            A: '#iceandfire:dragon_hearts',
            B: 'gtceu:dense_dark_soularium_plate',
            C: '#gtceu:circuits/zpm',
        }).id('kubejs:artificial_dragon_forge')
    // Using dragonblood
    event.recipes.gtceu.artificial_dragon_forge('kubejs:fire_dragonsteel_omnic')
        .itemInputs('gtceu:hot_red_steel_ingot', 'iceandfire:fire_dragon_blood', '8x iceandfire:dragonbone', '8x #iceandfire:scales/dragon/fire')
        .itemOutputs('iceandfire:dragonsteel_fire_ingot')
        .inputFluids('kubejs:molten_pyrotheum 1000')
        .duration(3600)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.artificial_dragon_forge('kubejs:ice_dragonsteel_omnic')
        .itemInputs('gtceu:hot_blue_steel_ingot', 'iceandfire:ice_dragon_blood', '8x iceandfire:dragonbone', '8x #iceandfire:scales/dragon/ice')
        .itemOutputs('iceandfire:dragonsteel_ice_ingot')
        .inputFluids('kubejs:molten_cryotheum 1000')
        .duration(3600)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.artificial_dragon_forge('kubejs:lightning_dragonsteel_omnic')
        .itemInputs('gtceu:hot_tungsten_carbide_ingot', 'iceandfire:lightning_dragon_blood', '8x iceandfire:dragonbone', '8x #iceandfire:scales/dragon/lightning')
        .itemOutputs('iceandfire:dragonsteel_lightning_ingot')
        .inputFluids('kubejs:molten_aerotheum 1000')
        .duration(3600)
        .EUt(GTValues.VA[GTValues.ZPM])
    // Not using dragonblood - more expensive, but easier to automate
    event.recipes.gtceu.artificial_dragon_forge('kubejs:fire_dragonsteel_omnic_no_blood')
        .itemInputs('gtceu:hot_red_steel_ingot', 'gtceu:hot_titanium_tungsten_carbide_ingot', '6x kubejs:diamond_lattice', '24x kubejs:wither_bone', '16x kubejs:ender_dragon_scale')
        .itemOutputs('iceandfire:dragonsteel_fire_ingot')
        .inputFluids('kubejs:molten_pyrotheum 8000')
        .duration(4800)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.artificial_dragon_forge('kubejs:ice_dragonsteel_omnic_no_blood')
        .itemInputs('gtceu:hot_blue_steel_ingot', 'gtceu:hot_ruridit_ingot', '6x kubejs:diamond_lattice', '24x kubejs:wither_bone', '16x kubejs:ender_dragon_scale')
        .itemOutputs('iceandfire:dragonsteel_ice_ingot')
        .inputFluids('kubejs:molten_cryotheum 8000')
        .duration(4800)
        .EUt(GTValues.VA[GTValues.ZPM])
    event.recipes.gtceu.artificial_dragon_forge('kubejs:lightning_dragonsteel_omnic_no_blood')
        .itemInputs('gtceu:hot_tungsten_carbide_ingot', 'gtceu:hot_manyullyn_ingot', '6x kubejs:diamond_lattice', '24x kubejs:wither_bone', '16x kubejs:ender_dragon_scale')
        .itemOutputs('iceandfire:dragonsteel_lightning_ingot')
        .inputFluids('kubejs:molten_aerotheum 8000')
        .duration(4800)
        .EUt(GTValues.VA[GTValues.ZPM])
