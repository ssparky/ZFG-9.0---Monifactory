...
ServerEvents.recipes(event => {
    ...
    event.remove({ output: ['thermal:dynamo_throttle_augment', 'thermal:upgrade_augment_1', 'thermal:upgrade_augment_2', 'thermal:upgrade_augment_3', 'thermalendergy:endergy_upgrade_1', 'thermalendergy:endergy_upgrade_2', 'thermalendergy:endergy_upgrade_3'] })
